...
export function renderSurveyTemplate(code, inviteUrl) {
  ...
  // NEW TONAL PALETTE
  const electricGreen = "#39ff14"; // Radioactive punch
  const softCyan = "#bcfeff";     // "Glow" Blue
  const mutedMagenta = "#cf4aff"; // Your working anchor
  const cosmicWhite = "#e0e0ff";  // Tinted white for body text
...
<body class="force-bg" style="margin: 0; padding: 0; background-color: ${deepPurple}; color: ${cosmicWhite}; font-family: 'Courier New', Courier, monospace;">
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        ...
        <table width="600" border="0" cellpadding="0" cellspacing="0" class="force-card-bg" style="max-width: 600px; width: 100%; background-color: ${darkerPurple}; border: 1px solid ${electricGreen}; border-radius: 40px; overflow: hidden; text-align: left;" role="presentation">
          ...
          <tr>
            <td background="${bgImgUrl}" style="background-image: url('${bgImgUrl}'); background-repeat: no-repeat; background-position: center 40px; background-size: 320px; padding: 40px 30px; font-family: 'Courier New', Courier, monospace; font-size: 14px; line-height: 1.6; color: ${cosmicWhite};">
              ...
              <p style="margin: 0 0 16px 0; color: ${cosmicWhite};">
                We’re excited to have you join the mission.
              </p>
              
              <p style="margin: 0 0 24px 0; color: ${cosmicWhite}; opacity: 0.9;">
                ...
                <span style="font-size: 11px; color: ${mutedMagenta}; opacity: 0.8;">(The link will stay active.)</span>
              </p>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 24px 0;" role="presentation">
                <tr>
                  <td width="50%" valign="top" style="padding-right: 15px; border-right: 1px dashed ${mutedMagenta};">
                    ...
                    <p style="margin: 0 0 12px 0; font-size: 11px; color: ${cosmicWhite}; opacity: 0.7;">Infiltration window opens</p>
                    ...
                    <p style="margin: 0; font-size: 11px; color: ${cosmicWhite}; opacity: 0.7;">Midday: Off-World Excursion<br/>6PM: Communal Feast</p>
                  </td>
                  <td width="50%" valign="top" style="padding-left: 15px;">
                    ...
                    <p style="margin: 0 0 14px 0; font-size: 11px; color: ${cosmicWhite}; opacity: 0.7;">6PM: Ride into the sky</p>
                    ...
                    <p style="margin: 0; font-size: 11px; color: ${cosmicWhite}; opacity: 0.7;">Midday: Brunch<br/>6PM: Soft Entertainment</p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 24px 0;" role="presentation">
                <tr>
                  <td align="center" style="border: 1px dashed ${softCyan}; background-color: ${darkerPurple}; padding: 18px; color: ${electricGreen}; font-weight: bold; font-size: 20px; letter-spacing: 4px;">
                    CODE: ${code}
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="border-top: 1px solid ${mutedMagenta}; padding: 15px 30px; font-size: 10px; text-transform: uppercase; color: ${softCyan}; opacity: 0.5; letter-spacing: 1px;">
