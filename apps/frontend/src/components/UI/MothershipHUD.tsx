    ...
    >
      <div className={styles.glassBase}>
        <div className={styles.navGroup}>
          <button className={styles.navItem} onClick={() => onNavigate('map')}>
          ...
          <button className={styles.navItem} onClick={() => onNavigate('itinerary')}>
            <div className={styles.iconSlot}>
              {/* Crystal/Stop Icon */}
              <svg viewBox="0 0 24 24" className={styles.iconSvg}>
          ...
          <button className={styles.navItem} onClick={() => onNavigate('brain')}>
            <div className={styles.iconSlot}>
              {/* Brain Icon */}
              <svg viewBox="0 0 24 24" className={styles.iconSvg}>
