      ...
      <div className="relative z-10 flex flex-col h-full p-6 md:p-10 overflow-hidden">
        ...
        <div className="flex flex-col items-center shrink-0 mb-6">
          ...
          <div className="flex flex-col items-center w-full max-w-2xl">
            ...
            <p className="text-[11px] text-white/50 tracking-[0.2em] uppercase mb-6">2. Confirm Event Attendance</p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap justify-center gap-8 md:gap-x-12">
            {[
              ...
              <div key={section.date} className="flex flex-col items-center text-center min-w-[200px] md:max-w-[240px]">
                ...
                <div className="text-lg font-bold tracking-tight text-white mb-2 uppercase opacity-90" onMouseEnter={() => scrambleRefs.current[section.key]?.triggerHover()}>
                  ...
                  <div className="space-y-2 w-full mt-2">
                    {section.keys.map(k => (
                      <button 
                        ...
                        className={`block w-full text-[9px] py-2 border transition-all uppercase ${
                          state[k as keyof typeof state] 
                            ? '!bg-[#00ffff] !text-black border-[#00ffff]' 
                            : 'text-white/30 border-white/10 hover:border-[#00ffff]/40 hover:text-white'
                        }`}
                      >
