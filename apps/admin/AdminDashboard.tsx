            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full lg:w-auto">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    className={`px-2 py-1 border border-primary text-xs sm:text-sm hover:bg-[#9ae68c] hover:text-surface transition-colors ${filter === "all" ? "bg-[#45CC2D] text-black" : ""}`}
                    onClick={() => setFilter("all")}
                  >
                    ALL
                  </button>
                  <button
                    className={`px-2 py-1 border border-primary text-xs sm:text-sm hover:bg-[#9ae68c] hover:text-surface transition-colors ${filter === "responded" ? "bg-[#45CC2D] text-black" : ""}`}
                    onClick={() => setFilter("responded")}
                  >
                    RESPONDED
                  </button>
                  <button
                    className={`px-2 py-1 border border-primary text-xs sm:text-sm hover:bg-[#9ae68c] hover:text-surface transition-colors ${filter === "not_responded" ? "bg-[#45CC2D] text-black" : ""}`}
