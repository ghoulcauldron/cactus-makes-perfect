      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000" style="background-color: #000000; width: 100%; color: #45CC2D; font-family: 'Courier New', Courier, monospace;">
        <tr>
          <td align="center" style="padding: 20px;">
            ...
            <table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#0a0a0a" style="max-width: 600px; width: 100%; background-color: #0a0a0a; border: 2px solid #45CC2D; text-align: left;">
              ...
              <tr>
                <td style="padding: 30px; font-size: 14px; line-height: 1.6; color: #45CC2D;">
                  ...
                  <div style="border: 1px dashed #45CC2D; padding: 15px; margin: 20px 0; text-align: center; color: #ffffff; font-size: 18px; letter-spacing: 3px;">
                    CODE: ${previewCode}
                  </div>
