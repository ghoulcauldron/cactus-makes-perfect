...
import { fetchGuestActivity, apiFetch } from "./api/client";
...
const kindMap: Record<string, { Icon: React.ElementType; label: string; emphasis?: boolean }> = {
  ...
  survey_sent:      { Icon: PaperAirplaneIcon, label: "Survey Sent", emphasis: true },
  survey_resent:    { Icon: PaperAirplaneIcon, label: "Survey Resent" },
  event_responses_updated: { Icon: PencilSquareIcon, label: "Neural Data Imprinted", emphasis: true },
      ...
      <div className="p-4 flex justify-between items-start border-b border-[#45CC2D]">
        ...
        <div className="p-4 flex-1 overflow-auto">
          <div className="grid grid-cols-1 gap-6 mb-8">
            ...
            {/* UPDATED SECTION: INVITE STATUS (BUTTON REMOVED) */}
            <div>
